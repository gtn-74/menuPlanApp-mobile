...
https://github.com/user-attachments/assets/1b35137c-badc-4d67-b592-b73882997e99
...
### 献立（Menu タブ）
- 🍳 日別表示 … その日の献立を並べて登録・編集・削除
- 🗓️ 週別表示 … 1週間を7列の表で見渡し、空いている日をその場で埋める
- ⚡ クイック追加 … 料理名だけで即登録（予算・材料は後から詳細フォームで）
- 💾 AsyncStorage に永続化（再起動しても残る）
